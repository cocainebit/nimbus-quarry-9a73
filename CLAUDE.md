...
| _(claude subagent F: studio-press)_ | `public/templates/studio-press/**`, `vendor/templates/studio-press/**`, `shared/source-templates-studio-press.json`, `tests/browser/studio-press.spec.ts`, one import + spread line in `shared/source-templates.mjs` | building the abstract essay-publication edition: purely typographic reading room, no photography, index plus issue plus essay plus masthead, CSS/SVG rules only, persistent reading controls (type size and light or dark reading mode) |
